...
class QuantizerConfig:
    ...
    # # Add by Dehua
    # pre_logits_dim: int = field(default=32)

    # For finite scalar quantizer
    levels: List = field(
        default_factory=lambda: [8, 5, 5, 5],
        metadata={'help': 'Quantization level of each dimension'},
    )
    l2_norm: bool = field(default=False, metadata={'help': 'Use L2 Norm before FSQ'})
    batch_norm: bool = field(default=False, metadata={'help': 'Use batch normalization before FSQ'})
